...
app.put('/getWaterLevelPoints', function(req, res) {
    dataBase.getWaterLevelPoints(req.body, function(docs) {
        if (docs != null) {
            res.status(200).send(docs);
        } else {
            res.status(400);
...
app.put('/getFlowRatePoints', function(req, res) {
    dataBase.getFlowRatePoints(req.body, function(docs) {
        if (docs != null) {
            res.status(200).send(docs);
        } else {
            res.status(400);
